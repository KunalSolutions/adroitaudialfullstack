           ...
           <ul className="space-y-3 text-white/70">
            <li>
              <Link
                ...
                to="/category/audio-equipment/microphone"
              >
                Microphones
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/audio-interfaces"
              >
                Audio Interfaces
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/monitor-speakers"
              >
                Monitor Speakers
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/monitor-speaker-bundle"
              >
                Monitor Speakers Bundle
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/mixers"
              >
                Mixers
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/studio-headphones"
              >
                Studio Headphones
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/pre-amps"
              >
                Pre Amps
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/sound-proofing"
              >
                Sound Proofing
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/groove-production"
              >
                Groove Production
              </Link>
            </li>
            <li>
              <Link
                className="hover:text-white"
                to="/category/audio-equipment/studio-accessories"
              >
                Studio Accessories
              </Link>
            </li>
